...
categoryCluster(root, tmp, "../interactome/json/aacr2018_adc_target_all_all.json")
tmp <- split(df.adc.all.y, factor(df.adc.all.y$target))
categoryCluster(root, tmp, "../interactome/json/aacr2018_adc_target_all_y.json")
tmp <- split(df.adc.all.n, factor(df.adc.all.n$target))
categoryCluster(root, tmp, "../interactome/json/aacr2018_adc_target_all_n.json")

tmp <- split(df.adc.academia.all, factor(df.adc.academia.all$target))
categoryCluster(root, tmp, "../interactome/json/aacr2018_adc_target_academia_all.json")
tmp <- split(df.adc.academia.y, factor(df.adc.academia.y$target))
categoryCluster(root, tmp, "../interactome/json/aacr2018_adc_target_academia_y.json")
tmp <- split(df.adc.academia.n, factor(df.adc.academia.n$target))
categoryCluster(root, tmp, "../interactome/json/aacr2018_adc_target_academia_n.json")

tmp <- split(df.adc.pharma.all, factor(df.adc.pharma.all$target))
categoryCluster(root, tmp, "../interactome/json/aacr2018_adc_target_pharma_all.json")
tmp <- split(df.adc.pharma.y, factor(df.adc.pharma.y$target))
categoryCluster(root, tmp, "../interactome/json/aacr2018_adc_target_pharma_y.json")
tmp <- split(df.adc.pharma.n, factor(df.adc.pharma.n$target))
categoryCluster(root, tmp, "../interactome/json/aacr2018_adc_target_pharma_n.json")

# SMI
tmp <- split(df.smi, factor(df.smi$target))
categoryCluster(root, tmp, "../interactome/json/aacr2018_smi_target_all_all.json")
tmp <- split(df.smi.all.y, factor(df.smi.all.y$target))
categoryCluster(root, tmp, "../interactome/json/aacr2018_smi_target_all_y.json")
tmp <- split(df.smi.all.n, factor(df.smi.all.n$target))
categoryCluster(root, tmp, "../interactome/json/aacr2018_smi_target_all_n.json")

tmp <- split(df.smi.academia.all, factor(df.smi.academia.all$target))
categoryCluster(root, tmp, "../interactome/json/aacr2018_smi_target_academia_all.json")
tmp <- split(df.smi.academia.y, factor(df.smi.academia.y$target))
categoryCluster(root, tmp, "../interactome/json/aacr2018_smi_target_academia_y.json")
tmp <- split(df.smi.academia.n, factor(df.smi.academia.n$target))
categoryCluster(root, tmp, "../interactome/json/aacr2018_smi_target_academia_n.json")

tmp <- split(df.smi.pharma.all, factor(df.smi.pharma.all$target))
categoryCluster(root, tmp, "../interactome/json/aacr2018_smi_target_pharma_all.json")
tmp <- split(df.smi.pharma.y, factor(df.smi.pharma.y$target))
categoryCluster(root, tmp, "../interactome/json/aacr2018_smi_target_pharma_y.json")
tmp <- split(df.smi.pharma.n, factor(df.smi.pharma.n$target))
categoryCluster(root, tmp, "../interactome/json/aacr2018_smi_target_pharma_n.json")
...
categoryCluster2(root, tmp, "../interactome/json/aacr2018_adc_tumor_all_all.json")
tmp <- split(df.adc.tumor.all.y, factor(df.adc.tumor.all.y$tumor))
categoryCluster2(root, tmp, "../interactome/json/aacr2018_adc_tumor_all_y.json")
tmp <- split(df.adc.tumor.all.n, factor(df.adc.tumor.all.n$tumor))
categoryCluster2(root, tmp, "../interactome/json/aacr2018_adc_tumor_all_n.json")

tmp <- split(df.adc.tumor.academia.all, factor(df.adc.tumor.academia.all$tumor))
categoryCluster2(root, tmp, "../interactome/json/aacr2018_adc_tumor_academia_all.json")
tmp <- split(df.adc.tumor.academia.y, factor(df.adc.tumor.academia.y$tumor))
categoryCluster2(root, tmp, "../interactome/json/aacr2018_adc_tumor_academia_y.json")
tmp <- split(df.adc.tumor.academia.n, factor(df.adc.tumor.academia.n$tumor))
categoryCluster2(root, tmp, "../interactome/json/aacr2018_adc_tumor_academia_n.json")

tmp <- split(df.adc.tumor.pharma.all, factor(df.adc.tumor.pharma.all$tumor))
categoryCluster2(root, tmp, "../interactome/json/aacr2018_adc_tumor_pharma_all.json")
tmp <- split(df.adc.tumor.pharma.y, factor(df.adc.tumor.pharma.y$tumor))
categoryCluster2(root, tmp, "../interactome/json/aacr2018_adc_tumor_pharma_y.json")
tmp <- split(df.adc.tumor.pharma.n, factor(df.adc.tumor.pharma.n$tumor))
categoryCluster2(root, tmp, "../interactome/json/aacr2018_adc_tumor_pharma_n.json")
...
categoryCluster2(root, tmp, "../interactome/json/aacr2018_smi_tumor_all_all.json")
tmp <- split(df.smi.tumor.all.y, factor(df.smi.tumor.all.y$tumor))
categoryCluster2(root, tmp, "../interactome/json/aacr2018_smi_tumor_all_y.json")
tmp <- split(df.smi.tumor.all.n, factor(df.smi.tumor.all.n$tumor))
categoryCluster2(root, tmp, "../interactome/json/aacr2018_smi_tumor_all_n.json")

tmp <- split(df.smi.tumor.academia.all, factor(df.smi.tumor.academia.all$tumor))
categoryCluster2(root, tmp, "../interactome/json/aacr2018_smi_tumor_academia_all.json")
tmp <- split(df.smi.tumor.academia.y, factor(df.smi.tumor.academia.y$tumor))
categoryCluster2(root, tmp, "../interactome/json/aacr2018_smi_tumor_academia_y.json")
tmp <- split(df.smi.tumor.academia.n, factor(df.smi.tumor.academia.n$tumor))
categoryCluster2(root, tmp, "../interactome/json/aacr2018_smi_tumor_academia_n.json")

tmp <- split(df.smi.tumor.pharma.all, factor(df.smi.tumor.pharma.all$tumor))
categoryCluster2(root, tmp, "../interactome/json/aacr2018_smi_tumor_pharma_all.json")
tmp <- split(df.smi.tumor.pharma.y, factor(df.smi.tumor.pharma.y$tumor))
categoryCluster2(root, tmp, "../interactome/json/aacr2018_smi_tumor_pharma_y.json")
tmp <- split(df.smi.tumor.pharma.n, factor(df.smi.tumor.pharma.n$tumor))
categoryCluster(root, tmp, "../interactome/json/aacr2018_smi_tumor_pharma_n.json")
...
categoryCluster(root, tmp, "../interactome/json/aacr2018_adc_sage_all_all.json")
tmp <- split(df.adc.all.y, factor(df.adc.all.y$sage_keyword))
categoryCluster(root, tmp, "../interactome/json/aacr2018_adc_sage_all_y.json")
tmp <- split(df.adc.all.n, factor(df.adc.all.n$sage_keyword))
categoryCluster(root, tmp, "../interactome/json/aacr2018_adc_sage_all_n.json")

tmp <- split(df.adc.academia.all, factor(df.adc.academia.all$sage_keyword))
categoryCluster(root, tmp, "../interactome/json/aacr2018_adc_sage_academia_all.json")
tmp <- split(df.adc.academia.y, factor(df.adc.academia.y$sage_keyword))
categoryCluster(root, tmp, "../interactome/json/aacr2018_adc_sage_academia_y.json")
tmp <- split(df.adc.academia.n, factor(df.adc.academia.n$sage_keyword))
categoryCluster(root, tmp, "../interactome/json/aacr2018_adc_sage_academia_n.json")

tmp <- split(df.adc.pharma.all, factor(df.adc.pharma.all$sage_keyword))
categoryCluster(root, tmp, "../interactome/json/aacr2018_adc_sage_pharma_all.json")
tmp <- split(df.adc.pharma.y, factor(df.adc.pharma.y$sage_keyword))
categoryCluster(root, tmp, "../interactome/json/aacr2018_adc_sage_pharma_y.json")
tmp <- split(df.adc.pharma.n, factor(df.adc.pharma.n$sage_keyword))
categoryCluster(root, tmp, "../interactome/json/aacr2018_adc_sage_pharma_n.json")

# SMI
tmp <- split(df.smi, factor(df.smi$sage_keyword))
categoryCluster(root, tmp, "../interactome/json/aacr2018_smi_sage_all_all.json")
tmp <- split(df.smi.all.y, factor(df.smi.all.y$sage_keyword))
categoryCluster(root, tmp, "../interactome/json/aacr2018_smi_sage_all_y.json")
tmp <- split(df.smi.all.n, factor(df.smi.all.n$sage_keyword))
categoryCluster(root, tmp, "../interactome/json/aacr2018_smi_sage_all_n.json")

tmp <- split(df.smi.academia.all, factor(df.smi.academia.all$sage_keyword))
categoryCluster(root, tmp, "../interactome/json/aacr2018_smi_sage_academia_all.json")
tmp <- split(df.smi.academia.y, factor(df.smi.academia.y$sage_keyword))
categoryCluster(root, tmp, "../interactome/json/aacr2018_smi_sage_academia_y.json")
tmp <- split(df.smi.academia.n, factor(df.smi.academia.n$sage_keyword))
categoryCluster(root, tmp, "../interactome/json/aacr2018_smi_sage_academia_n.json")

tmp <- split(df.smi.pharma.all, factor(df.smi.pharma.all$sage_keyword))
categoryCluster(root, tmp, "../interactome/json/aacr2018_smi_sage_pharma_all.json")
tmp <- split(df.smi.pharma.y, factor(df.smi.pharma.y$sage_keyword))
categoryCluster(root, tmp, "../interactome/json/aacr2018_smi_sage_pharma_y.json")
tmp <- split(df.smi.pharma.n, factor(df.smi.pharma.n$sage_keyword))
categoryCluster(root, tmp, "../interactome/json/aacr2018_smi_sage_pharma_n.json")
...
categoryCluster(root, tmp, "../interactome/json/aacr2018_adc_model_all_all.json")
tmp <- split(df.adc.all.y, factor(df.adc.all.y$model))
categoryCluster(root, tmp, "../interactome/json/aacr2018_adc_model_all_y.json")
tmp <- split(df.adc.all.n, factor(df.adc.all.n$model))
categoryCluster(root, tmp, "../interactome/json/aacr2018_adc_model_all_n.json")

tmp <- split(df.adc.academia.all, factor(df.adc.academia.all$model))
categoryCluster(root, tmp, "../interactome/json/aacr2018_adc_model_academia_all.json")
tmp <- split(df.adc.academia.y, factor(df.adc.academia.y$model))
categoryCluster(root, tmp, "../interactome/json/aacr2018_adc_model_academia_y.json")
tmp <- split(df.adc.academia.n, factor(df.adc.academia.n$model))
categoryCluster(root, tmp, "../interactome/json/aacr2018_adc_model_academia_n.json")

tmp <- split(df.adc.pharma.all, factor(df.adc.pharma.all$model))
categoryCluster(root, tmp, "../interactome/json/aacr2018_adc_model_pharma_all.json")
tmp <- split(df.adc.pharma.y, factor(df.adc.pharma.y$model))
categoryCluster(root, tmp, "../interactome/json/aacr2018_adc_model_pharma_y.json")
tmp <- split(df.adc.pharma.n, factor(df.adc.pharma.n$model))
categoryCluster(root, tmp, "../interactome/json/aacr2018_adc_model_pharma_n.json")

# SMI
tmp <- split(df.smi, factor(df.smi$model))
categoryCluster(root, tmp, "../interactome/json/aacr2018_smi_model_all_all.json")
tmp <- split(df.smi.all.y, factor(df.smi.all.y$model))
categoryCluster(root, tmp, "../interactome/json/aacr2018_smi_model_all_y.json")
tmp <- split(df.smi.all.n, factor(df.smi.all.n$model))
categoryCluster(root, tmp, "../interactome/json/aacr2018_smi_model_all_n.json")

tmp <- split(df.smi.academia.all, factor(df.smi.academia.all$model))
categoryCluster(root, tmp, "../interactome/json/aacr2018_smi_model_academia_all.json")
tmp <- split(df.smi.academia.y, factor(df.smi.academia.y$model))
categoryCluster(root, tmp, "../interactome/json/aacr2018_smi_model_academia_y.json")
tmp <- split(df.smi.academia.n, factor(df.smi.academia.n$model))
categoryCluster(root, tmp, "../interactome/json/aacr2018_smi_model_academia_n.json")

tmp <- split(df.smi.pharma.all, factor(df.smi.pharma.all$model))
categoryCluster(root, tmp, "../interactome/json/aacr2018_smi_model_pharma_all.json")
tmp <- split(df.smi.pharma.y, factor(df.smi.pharma.y$model))
categoryCluster(root, tmp, "../interactome/json/aacr2018_smi_model_pharma_y.json")
tmp <- split(df.smi.pharma.n, factor(df.smi.pharma.n$model))
categoryCluster(root, tmp, "../interactome/json/aacr2018_smi_model_pharma_n.json")
